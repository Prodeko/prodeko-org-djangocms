    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(default=datetime.date(2018, 12, 30))),
                ('deadline_date', models.DateField(blank=True, default=datetime.date(2018, 12, 30), null=True)),
                ('show_deadline', models.BooleanField(default=False)),
                ('visible', models.BooleanField(default=True)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='tiedotteet.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='message',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, related_name='messages', to='tiedotteet.Tag'),
        ),
    ]
