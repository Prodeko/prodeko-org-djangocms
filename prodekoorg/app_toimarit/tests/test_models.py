...
class HallituksenJasenModelTest(TestData):
    ...
    @english
    def test_firstname_label_english(self):
        field_label = self.test_hallituksenjasen1._meta.get_field('firstname').verbose_name
        self.assertEquals(field_label, 'First name')
    ...
    @english
    def test_lastname_label_english(self):
        field_label = self.test_hallituksenjasen1._meta.get_field('lastname').verbose_name
        self.assertEquals(field_label, 'Last name')
    ...
    @english
    def test_position_label_english(self):
        field_label = self.test_hallituksenjasen1._meta.get_field('position').verbose_name
        self.assertEquals(field_label, 'Position')
