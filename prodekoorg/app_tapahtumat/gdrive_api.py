...
def filter_gdrive_folders_dict(folders_dict):
    ...
    Args:
        folders_dict: Dictionary folder info that gets converted to Tapahtuma models.
    ...
    existing_gdrive_ids = Tapahtuma.objects.values_list("gdrive_id", flat=True)
...
def create_models_from_folders(request, service, folders_dict):
    ...
    Args:
        ...
        folders_dict: Python dictionary containing
            containing info that gets converted to Tapahtuma models.
    ...
    for parent_id, folder_name in filtered_dict.items():
        try:
            ...
            # Create the new Tapahtuma object and save 'final_pdf'
            doc = Tapahtuma.objects.create(
...
def run_app_tapahtumat(request):
    ...
    4. Redirect to the Tapahtuma admin page and display either
    ...
    Returns:
        Redirects to the main admin Tapahtuma page.
    ...
    return redirect("/admin/app_tapahtumat/Tapahtuma/")
