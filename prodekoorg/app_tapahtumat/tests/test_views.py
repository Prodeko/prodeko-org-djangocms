...
class TapahtumaViewTest(TestData):
    """Tests for views in the app_tapahtumat app."""

    def test_tapahtumat_and_redirect_if_not_logged_in(self):
        """
        Tests redirect to login page if the main tapahtumat page is
        accessed and the user is not logged in.
        """
        response = self.client.get(reverse("app_tapahtumat:documents"))
    ...
    def test_admin_download_not_authorized(self):
        ...
        self.assertRedirects(
            response, "/fi/admin/login/?next=/fi/admin/app_tapahtumat/download"
        )
    ...
    def test_admin_download_authorized(self):
        ...
        self.assertRedirects(response, "/fi/admin/app_tapahtumat/Tapahtuma/")
