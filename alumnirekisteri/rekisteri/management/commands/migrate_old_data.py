...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open('old_data_files/yo_kunnianosoitukset.json', encoding="utf8") as yo_kunn_file:
            yo_kunn = json.load(yo_kunn_file)['data']
        with open('old_data_files/jarjestotoiminta.json', encoding="utf8") as jarjestotoiminta_file:
        ...
        with open('old_data_files/luottamustehtavat.json', encoding="utf8") as luottamustehtavat_file:
        ...
        for user in users:
            ...
            if user['ID'] == 2189: #sama henkilö kuin 2188
                ...
                continue
            elif user['ID'] == 797 or user['ID'] == 2534 or user['ID'] == 2535 or user['ID'] == 2515:
                continue
        ...
        for persu in perus:
            ...
            if id_num == 1183: #sama kuin 2360 mutta vanhempi entry, fiksaus loopin jälkeen
                continue
            elif id_num == 2386: #sama kuin 1990, mutta tyhjä
                continue
            elif id_num == 2257 or id_num == 2515: #täysin tyhjä entry, epäilyttävästi vesikiven maili = jotain säätöä, toinenkin tyhjä
                continue
            ...
            if(persu['Työpuhelinnumero'] and persu['Työpuhelinnumero'] != 'NULL'):
                num = ""
                if(persu['Työmaasuuntanumero'] and persu['Työmaasuuntanumero'] != 'NULL'):
        ...
        for tekn in teknop:
            ...
            if(tekn['Perustutkinto'] == 'DI' or tekn['Perustutkinto'] == 'Arkkit.' or tekn['Perustutkinto'] == 'TkK'):
                e.degree_level = 3
        ...
        for tyo in vanhatyo:
            ...
            if tyo['Lopetusvuosi'] and not tyo['Lopetusvuosi'] == '-' and not tyo['Lopetusvuosi'] == 'current':
        ...
        for entop in edelt_op:
            ...
            if(entop['Oppilaitos'] or entop['Tutkinto'] or entop['Koulutusohjelma _ Laitos']):
                if(entop['Oppilaitos']):
                    e.school = entop['Oppilaitos']
                if(entop['Tutkinto']):
                    a = entop["Tutkinto"]
                    b = a.lower()
                    if  'ylioppilas' in b or 'yo' in b or 'baccalaureat' == b or 'student' == b:
                        e.degree_level = 1
                        e.description = 'Ylioppilastutkinto'
                    elif  'high school' in b or 'hs diploma' in b or 'diploma' in b or 'avgå' in b or 'liiketa' in b or 'teknik' in b or 'opistoup' in b or 'abitur' == b or 'gcse' == b or 'leavin' in b or 'reife' in b or 'graduate' == b or 'automek' in b:
                        e.degree_level = 1
                        e.description = a
                    elif  'insin' in b or 'ohjaaj' in b or 'kapteen' in b or 'Upseeri' == a or 'trade' in b or 'upseerin' in b or 'logist' in b:
                        e.degree_level = 2
                        e.description = a
                    elif  'baccal' in b or 'ib' in b:
                        e.degree_level = 1
                        e.description = 'International Baccalaureate'
                    elif  'maister' in b or 'magister' in b or 'master' in b or 'mba' in b or 'virkatut' in b or 'wirtschaft' in b or 'yleises' in b or 'service' in b or 'vordip' in b or 'arkkit' in b or 'industrial' in b or 'ktm' in b or 'fm' in b or 'nieur' in b:
                        e.degree_level = 3
                        e.description = a
                    elif  'ekonomi' in b:
                        e.degree_level = 3
                        e.description = a
                    elif  'kand' in b or 'bach' in b or 'cand' in b or 'civi' in b or 'erikoistu' in b:
                        e.degree_level = 2
                        e.description = a
            ...
            if(entop['Valmistumisvuosi'] or entop['Aloitusvuosi'] or entop['Tiedekunta _ Osasto']):
        ...
        for jatk in jatkop:
            ...
            if(jatk['Oppilaitos'] or jatk['Tutkinto'] or jatk['Koulutusohjelma Laitos']):
                ...
                if(jatk['Tutkinto']):
                    ...
                    elif 'lise' in b or 'lice' in b or 'keuhkosai' in b or 'karexam' in b or 'licte' in b or 'ktl' in b or 'll 1998' in b or 'tekn. lis' in b or 'psl' in b or 'tkl' in b or 'lääkär' in b:
                        e.degree_level = 4
                        e.description = a
                    elif 'tohtori' in b or 'doct' in b or 'dr' in b or 'ktt' == b or 'ft' == b or 'ph.d' in b or 'd.sc' in b:
                        e.degree_level = 5
                        e.description = a
                    elif 'maister' in b or 'master' in b or 'magister' in b or 'mba' in b or 'ekonomi' == b or 'ktm' in b or 'psm' in b or 'otm' == b or 'di' == b or 'graduate di' in b:
                        e.degree_level = 3
                        e.description = a
                    elif 'esikunta' in b or 'fm' in b or 'vtm' in b or 'diploma in' in b or 'msc' in b or 'psm' in b:
                        e.degree_level = 3
                        e.description = a
                    elif 'kand' in b or 'bach' in b or 'bsc' == b or 'insin' in b or 'trad' in b or 'bba' in b or 'ktk' in b or 'humk' in b or 'on' == b or 'oikeusnotaari' in b or 'vtk' in b:
                        e.degree_level = 2
                        e.description = a
            ...
            if(jatk['Valmistumisvuosi'] or jatk['Aloitusvuosi'] or jatk['Tiedekunta Osasto']):
